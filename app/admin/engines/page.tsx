...
import { Star, Search, Sparkles, ArrowRight, Activity, Zap, Signal } from "lucide-react";
      ...
      <div className="rounded-[28px] border border-cyan-400/20 bg-[linear-gradient(135deg,rgba(8,47,73,0.85),rgba(15,23,42,0.92))] p-6 shadow-[0_24px_80px_rgba(8,47,73,0.25)] sm:p-8">
        <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
          ...
          <div className="flex shrink-0 items-center gap-3">
            <Link
              href="/admin/engines/status"
              className="flex items-center gap-2 rounded-2xl border border-emerald-400/20 bg-emerald-400/10 px-4 py-3 text-xs font-semibold text-emerald-300 hover:bg-emerald-400/20 hover:text-white transition-all"
            >
