...
import { BookOpen, Cloud, FileUp, ImageIcon, Sparkles } from "lucide-react";
import AdminLessonUploadForm from "@/src/components/admin/AdminLessonUploadForm";

export const metadata: Metadata = {
  title: "Upload Lesson | Python Arena Admin",
  description: "Upload PDF lessons and thumbnails into the LMS admin workflow.",
};
