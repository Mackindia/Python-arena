...
export default function ClassError({ error, reset }: ClassErrorProps) {
  return (
    <main className="min-h-screen bg-black px-4 py-14 text-white sm:px-6 lg:px-10">
      <div className="mx-auto max-w-2xl rounded-2xl border border-red-400/30 bg-slate-950 p-6">
        <h1 className="text-2xl font-bold text-red-300">Unable to load this class</h1>
        <p className="mt-3 text-sm text-slate-300">
          There was a problem loading class-level lessons.
        </p>
